...
def get_config():
  ...
  print(epsilon)
  cfg.system.make_local_energy_fn = "ferminet.pbc.Hamiltonian_minimalChern.local_energy_enforce_real"
  ...
  cfg.network.network_type = "psiformer_momind"
  ...
  #cfg.optim.lr.onecycle_steps = 200000
  #cfg.optim.lr.rate_max = 0.1
  #cfg.optim.lr.onecycle_start = 0.0001
  ...
  cfg.initialization.donor_filename = "ferminet_2025_08_24_11:33:55 copy"
  cfg.initialization.flatten_num_devices = False
  cfg.targetmom.mom = 13
  cfg.targetmom.kwargs = {"abs_lattice": Tmatrix, "unit_cell_vectors": np.array([a1,a2]), "logsumtrick": False}
