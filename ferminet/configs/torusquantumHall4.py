...
def get_config():
  ...
  a2 = a * np.array([0, 1.0])
  Tmatrix = np.array([[np.sqrt(24),0], [0, np.sqrt(24)]])  
  ...
  cfg.network.psiformer_magfield.kwargs = {"lattice": lattice, "N_phi": np.array(24.0),"zeros": jnp.asarray(zeros_complex, jnp.complex64),"rescale": np.array(1.0),"N_holo": 24, "N_anti": 0,"bf_strength_init" : 0.01}
