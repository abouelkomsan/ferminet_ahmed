...
def get_config():
  ...
  cfg.initialization.donor_filename = f"/work/submit/ahmed95/data/8particles_inference/{cfg.targetmom.mom}"
  ...
  cfg.log.save_path = f"/work/submit/ahmed95/data/8particles_inference/{cfg.targetmom.mom}"
