...
def get_config():
  ...
  cfg.initialization.donor_filename = "/data/ahmed95/NN_minimalChern/8particles_withflux/1.0/"
  cfg.log.save_path = '/data/ahmed95/NN_minimalChern/8particles_withflux/1.0/extrarun/'
